...
if(employee.numYearEmployment<5 && employee.department==="Engineering") {console.log(`meets the criteria`)} 
else if (employee.numYearEmployment<15 && employee.department==="Engineering") {console.log(`does notmeets the criteria`)};
